...
import { Upload, FileText, Check, Route } from 'lucide-react';
...
export function FileUploader({ onFileProcessed }: FileUploaderProps) {
  ...
  return (
    <div className="space-y-4">
      <div className="border-2 border-dashed border-border rounded-lg text-center hover:border-primary transition-colors pt-[24px] pr-[32px] pb-[12px] pl-[32px]">
        <input
          ref={fileInputRef}
          type="file"
          accept=".gpx,.tcx"
